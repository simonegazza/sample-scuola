...
class JConfig
{
	...
	public $sitename = 'sample-scuola';            // Name of Joomla site
	...
	/* Server Settings */
	public $secret = 'PMmnIiu5pLFNgSug';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_root = '';
	public $ftp_enable = '0';
	public $tmp_path = '/var/www/html/sample-scuola/tmp/';                // This path needs to be writable by Joomla!
	public $log_path = '/var/www/html/sample-scuola/logs/'; // This path needs to be writable by Joomla!
